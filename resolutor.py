...
def extrair_numero_principal_documento(texto_doc: str) -> str | None:
    ...
    A ideia é identificar o número do próprio processo/acórdão,

    evitando confundir com números de processos citados no corpo.
...
def resolver_citacoes(
    ...
    for idx, cit in enumerate(citacoes_brutas, 1):
        ...
        if matches:
            ...
            # ========================================================
            # CORREÇÃO:
            # verifica se o número citado é o processo principal
            ...
            if len(matches) == 1:
                ...
                # Mesmo havendo apenas um resultado, precisamos verificar
                # se ele é realmente o documento cujo número foi citado.

                numero_principal = extrair_numero_principal_documento(
                    matches[0][5]
                )

                if numero_principal == re.sub(
                    r"\D",
                    "",
                    cnj_limpo
                ):
                ...
                for (
                    ...
                    numero_principal = (
                        extrair_numero_principal_documento(
                            texto_doc
                        )
                    )

                    # Regra principal:
                    # o número citado precisa ser o número principal
                    # do próprio documento encontrado.
                ...
                id_canonico_escolhido = melhor_doc_id

            # ========================================================
            # Só classifica como REAL se encontramos um documento
            # cujo número principal corresponde ao número citado.
            # ========================================================
            ...
            if id_canonico_escolhido is not None:
                ...
                # O número foi encontrado no banco, mas nenhum
                # documento possui esse número como processo principal.
